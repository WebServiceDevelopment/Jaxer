...
const unsigned long int Cr_r_tab[(MAXJSAMPLE+1) * sizeof(int)] ={
...
const unsigned long int Cb_b_tab[(MAXJSAMPLE+1) * sizeof(int)] ={
...
const unsigned long int Cr_g_tab[(MAXJSAMPLE+1) * sizeof(int)] ={
